...
This accuracy issue could be remedied by collecting more ratings and more information about each movie. First, I would like to collect more movie ratings for to get a more robust number for the average genre rating. Secondly, I would love to add additional data for the movie. Some examples include, the gender of the lead actor, release date to group by month of release, and Oscar nominations and awards won.

Creating a larger dataset with more descriptive information about the movies can help create a better movie recommendation list for each survey participant.
